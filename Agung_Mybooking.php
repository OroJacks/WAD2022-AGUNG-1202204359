...
<html lang="en">
  <head>
    ...
    <title>Booking Mobil PBB BLOK E NO 16</title>
          ...
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
              <svg class="bi me-2" width="40" height="32" role="img" aria-label="Bootstrap"><use xlink:href="#bootstrap"></use></svg>
               ...
               <a href="Agung_home.php" class="nav-link px-2 text-white">Home</a>
               <a href="Agung_Mybooking.php" class="nav-link px-2 text-white">Booking</a>
          </div>
        </div>
      </header>
  ...
  <section class="py-5 text-center container">
    <div >
      <div class="col-lg-6 col-md-8 mx-auto">
        <h4>Thank You <?php echo $agung ?> for Reserving</h4>
