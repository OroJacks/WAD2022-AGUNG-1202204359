            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <h5>Selamat Datang di Showroom Agung, Silahkan Registrasi!</h5>
            </div>
        </nav>
</head>
      ...
      <section>
        <div class="container px-5 py-5 ">
            <div class="row align-items-center">
                <div class="col-sm">
                    <img src="https://www.motortrend.com/uploads/2022/02/2022-Lamborghini-Aventador_524148.jpg"  height = "350px"alt="...">    
                </div>
                <div class="col-sm">
