    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="../pages/Addmobil.php">Mycar</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="container py-5">
            ...
            <form method="post" action="../config/insert.php" enctype="multipart/form-data">
                ...
                <input type="text" id="pemilik" class="form-control mb-3" name="pemilik" value="M. Agung Rizaldi-1202204359" readonly>
